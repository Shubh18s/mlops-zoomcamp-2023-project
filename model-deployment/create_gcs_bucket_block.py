...
PREFECT_FLOWS_BUCKET = "citibike-scoring-prefect-flows"
...
if __name__ == "__main__":
    create_gcs_bucket_block(bucket_name=PREFECT_FLOWS_BUCKET, folder="model-scoring") # block_name = "citibike-scoring-bucket"